...
- **accumulator mechanical** @ [formula electric at berkeley](https://ev.berkeley.edu/) -- designing and manufacturing the attic casing for a 588V li-ion battery pack. high-voltage insulation, waterproofing, structural analysis under FSAE crash loads.
- **undergraduate researcher** @ [ramesh lab (lbl)](https://rameshlab.lbl.gov) -- complex-oxide thin films via PLD for next-gen memory. learning substrate prep, RHEED, AFM/XRD/PFM characterization.
...
**languages & frameworks:** `python` `java` `typescript` `javascript` `sql` `html/css` `react` `next.js` `node.js` `tailwind`
